...
namespace YARG.Input
{
    ...
    ///     fires star power. <see cref="TouchGuitarInput"/> feeds it during
    ///     gameplay only, so menus never see it, and it carries no menu binds.
    ///     Profiles bind it like any other controller.
    /// </summary>
    [Preserve]
